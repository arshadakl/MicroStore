...
export function StoreFooter({ storeName, whatsappNumber }: StoreFooterProps) {
  ...
  return (
    <footer
      className="mt-16 py-10 text-center space-y-3"
      style={{ borderTop: "1px solid var(--store-border)", backgroundColor: "var(--store-card-bg)" }}
    >
      <p className="text-xl font-bold" style={{ color: "var(--store-text)" }}>
        {storeName}
      </p>
      <a
        href={waUrl}
